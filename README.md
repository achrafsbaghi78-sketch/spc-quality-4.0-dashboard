...
### 🎯 Overview
**Master Génie Industriel | PFE 2026** | This platform implements **IATF 16949:2016 §8.5.1.1** requirements for Statistical Process Control in automotive parts manufacturing. 
...
2. **🎯 Capability Analysis** - Cp, Cpk, Pp live calculation with IATF 16949 thresholds (Cp>1.33)
3. **🚨 Smart Alerts System** - 8 Western Electric rules detection + Corrective action guidance
4. **📄 8D Report Generator** - One-click PDF export for customer complaints IATF compliant
5. **📊 Live Data Integration** - Google Sheets API for shop floor connectivity

### 🛠️ Tech Stack
`Python` `Streamlit` `Plotly` `Pandas` `NumPy` `Google Sheets API` `IATF 16949` `Lean Six Sigma`
...
- **100%** IATF 16949 audit-ready documentation
